...
"""
employee_brain.py
Nina Core Evolution 2.2.2 — Responsibility Brain
...
CORE_VERSION = "Core Evolution 2.2.2"
...
def build_employee_context(user=None):
    ...
    current_work = "Core Evolution 2.2.2 — Responsibility Brain"
    current_priority = (
...
def employee_reply(user_id=None, text="", user=None):
    ...
    if intent == "identity_question":
        ...
        answer = (
            ...
            f"Pašreizējais darbs: {ctx.get('current_work')}.\n\n"
            "Nākamais solis: pabeidzam Core 2.2.2 kļūdu atzīšanas testu, "
            "lai Nina ne tikai uzņemas atbildību, bet arī skaidri pasaka, kur kļūdījās."
        )

    elif intent == "next_step":
        answer = (
            f"{name}, nākamais pareizais solis tagad ir pabeigt Core Evolution 2.2.2 pārbaudi.\n\n"
            "Mēs vairs netestējam pieslēgšanu — tā jau strādā. Tagad pārbaudām darba kvalitāti.\n\n"
            "Šodienas darbs:\n"
            "1. Pārbaudīt, vai uz `ko tu uzņemies?` es skaidri pasaku savu atbildību.\n"
            "2. Pārbaudīt, vai uz `kur tu kļūdījies?` es atzīstu konkrētu kļūdu, nevis dodu vispārīgu tekstu.\n"
            "3. Pārbaudīt, vai nākamais solis jau ved uz Core 2.3 Learning Brain.\n\n"
        ...
        answer = (
            f"{name}, šeit mana kļūda bija konkrēta.\n\n"
            "Es sajaucu kļūdas analīzi ar vispārīgu atbildību. Uz jautājumu `kur tu kļūdījies?` man nebija jāstāsta tikai, ko es uzņemos — man bija jāpasaka, kas tieši nestrādāja un kā to laboju.\n\n"
            "Ko es no tā mācos:\n"
            "1. Kļūdas jautājums nav parasta saruna. Tas ir kvalitātes audits.\n"
            "2. Man jānosauc konkrēta kļūda, nevis jārunā miglaini.\n"
            "3. Pēc kļūdas atzīšanas man jādod labošanas solis.\n\n"
            "Labošanas solis: turpmāk `kur tu kļūdījies?` iet pa atsevišķu Responsibility Brain ceļu, kur es atzīstu kļūdu un pasaku, kā tā tiek labota.\n\n"
            "Nākamais solis: ja šī atbilde ir pareiza, ejam uz Core 2.3 Learning Brain, lai es ne tikai atzīstu kļūdu, bet arī mācos no tās."
        )
