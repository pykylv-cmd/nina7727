...
export const companyPublicDisconnectStatus=code=>{const classification=disconnectClassification(code);return classification==='logged_out'||classification==='invalid_auth'?classification:'connecting'}
