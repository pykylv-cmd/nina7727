...
_SCHEMA_READY = False
_SCHEMA_TARGET = ""
ALLOWED_CHANNELS = {"web", "telegram", "whatsapp", "email", "whatsapp_personal", "ninaos_number", "whatsapp_company"}
ALLOWED_STATUSES = {"disconnected", "pending", "connected", "suspended", "error"}
