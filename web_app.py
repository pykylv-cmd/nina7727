...
# web_app.py
# NinaOS Web App V51.2 — Telegram Client Contact Mapping
# Web service start command: python web_app.py
# Telegram service start command stays: python app.py
...
WEB_APP_VERSION = "Web App V51.2 — Telegram Client Contact Mapping"
app = Flask(__name__)
...
def telegram_contact_mapping_form_html():
    ...
    ) or rows_for([], "No verified Telegram client mappings yet.")
    action = q('/outbox')
...
def outbox_body(data=None):
    ...
    return (
        work_page_header("Outbox", "V51.2 Telegram Client Contact Mapping — verified client chat_id mapping before any real send bridge.")
        + review_banner
        + send_prep_banner
