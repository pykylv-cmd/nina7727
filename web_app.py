...
def css():
    return """
.chat-layout{display:grid;grid-template-columns:minmax(0,1fr) 310px;gap:18px}.chat-shell{height:calc(100vh - 130px);min-height:520px;max-height:820px;display:flex;flex-direction:column;overflow:hidden}.chat-head{display:flex;align-items:center;gap:14px;padding-bottom:18px;border-bottom:1px solid var(--line2);flex:0 0 auto}.chat-stream{display:flex;flex:1 1 auto;flex-direction:column;gap:14px;min-height:0;overflow-y:auto;padding:22px 4px}.chat-message{max-width:78%;padding:14px 17px;border-radius:18px;line-height:1.55;white-space:pre-wrap}.chat-message.user{align-self:flex-end;background:linear-gradient(135deg,#187fff,#6544ff)}.chat-message.nina{align-self:flex-start;background:rgba(255,255,255,.07);border:1px solid var(--line)}.chat-message small{display:block;margin-top:7px;color:#bfd0ef}.chat-compose{display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:end;gap:12px;flex:0 0 auto;margin-top:0;padding-top:16px;border-top:1px solid var(--line2);background:rgba(9,12,24,.96)}.chat-compose textarea{width:100%;min-width:0;min-height:72px;max-height:160px;resize:vertical;border:1px solid var(--line);border-radius:16px;background:rgba(5,9,20,.62);color:var(--text);padding:15px;font:inherit}.chat-compose .form-actions{margin:0;flex-wrap:nowrap}.chat-compose .btn{min-width:112px;min-height:48px}.channel-card{display:flex;justify-content:space-between;gap:10px;padding:14px 0;border-bottom:1px solid var(--line2)}.channel-card:last-child{border-bottom:0}.channel-state{font-size:12px;font-weight:950;color:var(--green)}.channel-state.next{color:#ffd057}@media(max-width:1100px){.chat-layout{grid-template-columns:1fr}.chat-shell{height:min(720px,calc(100vh - 40px));min-height:500px}}@media(max-width:640px){.chat-message{max-width:92%}.chat-shell{height:auto;min-height:520px;max-height:none}.chat-stream{min-height:260px;max-height:48vh}.chat-compose{grid-template-columns:1fr}.chat-compose .btn{width:100%}}
