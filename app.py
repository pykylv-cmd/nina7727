...
def stripe_env_guide_answer(user_id=None):
    """V11.6 Stripe ENV Guide — skaidri parāda Railway ENV iestatījumus Stripe palaišanai."""
    checks = [
        ("STRIPE_SECRET_KEY", STRIPE_SECRET_KEY, "Stripe slepenā atslēga: sk_test_..."),
        ("STRIPE_BASIC_PRICE_ID", STRIPE_BASIC_PRICE_ID, "Basic abonementa Price ID: price_..."),
        ("STRIPE_PLUS_PRICE_ID", STRIPE_PLUS_PRICE_ID, "Plus abonementa Price ID: price_..."),
        ("STRIPE_SUCCESS_URL", STRIPE_SUCCESS_URL, "Lapa pēc veiksmīga maksājuma"),
        ("STRIPE_CANCEL_URL", STRIPE_CANCEL_URL, "Lapa, ja maksājums atcelts"),
    ...
    for key, value, description in checks:
        is_ready = bool(value and value not in ["https://t.me/"])
        if is_ready:
            ready_count += 1
