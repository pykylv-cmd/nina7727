...
@app.route("/")
def home():
    return "Nina7727 V12.6 Daily Habit Launch darbojas! DB: " + ("PostgreSQL" if USE_POSTGRES else "SQLite fallback")
...
if __name__ == "__main__":
    print("Nina7727 V12.6 Daily Habit Launch darbojas...", "PostgreSQL" if USE_POSTGRES else "SQLite fallback")
