...
def subscription_info(user_id=None):
    return (
        ...
        "Maksājumi vēl nav pilnībā pieslēgti. Šis ir V10.24 Admin User Search."
    )
...
async def reply(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # V10.24.1: KPI command routing fix — catch KPI before GPT fallback.
    if lower in ["kpi", "admin kpi", "business dashboard", "admin kpi dashboard", "kpi dashboard", "biznesa panelis"]:
...
@app.route("/")
def home():
    return "Nina7727 V10.24 Admin KPI Dashboard darbojas! DB: " + ("PostgreSQL" if USE_POSTGRES else "SQLite fallback")
...
if __name__ == "__main__":
    print("Nina7727 V10.24 Admin KPI Dashboard darbojas...", "PostgreSQL" if USE_POSTGRES else "SQLite fallback")
