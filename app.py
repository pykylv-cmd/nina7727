...
def subscription_info(user_id=None):
    """V11.2 Stripe Setup Helper — skaidrs abonementa piedāvājums Free lietotājiem."""
...
@app.route("/")
def home():
    return "Nina7727 V11.2 Stripe Setup Helper darbojas! DB: " + ("PostgreSQL" if USE_POSTGRES else "SQLite fallback")
...
if __name__ == "__main__":
    print("Nina7727 V11.2 Stripe Setup Helper darbojas...", "PostgreSQL" if USE_POSTGRES else "SQLite fallback")
